...
## 현재 상태 (2026-09-07)
- **마지막 작업**: 합동시공 금요일(9/4)분 반영(`7f6ff82`) · 주말 등재분은 직전 금요일로 모으는 규칙 추가. 통계 개소 기준을 **지번(건물)** 으로 교정(`cd77997`) · 데이터셋 레지스트리 단일화(`9c80f1e`·`f961816`).
- **배포 상태**: ami-work `7f6ff82` / 아미큐 **2.2.17**(교체 M1020 지원) / 종로맵 20260813.3 / 헬퍼 1.0.77·inject v80.
- **지도 데이터**: 실효 3,958 · 재방문 138 · 고압 239 · 합동 747(9/2~9/4, 3일 보존) · 장애 323그룹 2,837계기 · SKT 41.
