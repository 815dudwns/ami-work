...
| 28 | 완료 |
| 29 | 완료/전송대기 (mobCst 화면 = 통신팀) |

> ★ **28은 API 이름이 아니라 작업단계 값이다.** 계기팀에서 완료(28)를 만드는 것 = `mobMtr4000/saveRow`에 `WORK_STEP=28`, `EX_WORK_STEP=25`를 실어 재전송. (saveAct 아님 — saveAct는 통신팀)
