...
const DATASETS = [
    { file: './data/site-data.json?v=20260529j', category: '실효', label: null,  uiLabel: '실효계기' },
    { file: './data/skt-data.json?v=20260529j',  category: 'skt',  label: 'SK', uiLabel: 'SKT' },
    { file: './data/tou-data.json?v=20260529j',  category: 'tou',  label: 'TOU', uiLabel: 'TOU' },
];
