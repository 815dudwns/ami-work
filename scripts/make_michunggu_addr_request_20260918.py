...
★열 구성은 PM 지정이다: 계기번호 · 모뎀MAC · 지사 · 최종시공일 · 현재확보주소(있으면).
...
COLS = ['계기번호', '모뎀MAC', '지사', '최종시공일', '현재확보주소(있으면)']
WIDTHS = [16, 20, 16, 20, 34]
...
def main():
    ...
    # 계기번호·MAC 은 앞 0 이 날아가지 않게 텍스트로 고정
