...
RULES = [
    ...
    dict(축코드='C5', 대상리스트='공통', 축이름='[폐기 2026-09-23] 마스터만 미청구 (함체 슬레이브 전부 청구)',
         ...
         되살리는법='★2026-09-23 폐기 — 123건 전부 되살렸다. 근거가 추정이었고 확인해 보니'
                    ' 성립하지 않았다: 마스터·슬레이브가 같은 날·같은 시공자·같은 구분으로'
                    ' 작업됐고(103/106 · 104/106) 봉인도 차이가 없다. 17건은 26년 1~3월에'
                    ' 모뎀을 LTE 로 갈았는데도 미청구이고, 새 MAC 으로 LP 를 긁어도 n/a 7 ·'
                    ' 0%% 3 으로 통신이 안 잡힌다. 106건도 LP 전회차 0%% 18 · n/a 53 이라'
                    ' 25년 모뎀을 갈아야 할 우리 일이다.'
                    ' 목록 research/C5_106건_LP별_20260923.json · C5_모뎀교체이력_20260923.json',
    ...
    dict(축코드='C8', 대상리스트='공통', 축이름='[폐기 2026-09-23] MAC 동일함체 26년시공',
         ...
         되살리는법='★2026-09-23 폐기 — 4건 전부 되살렸다. 26년 앱 작성 때 계기번호를 잘못'
                    ' 넣으면 그 계기는 청구가 안 되므로, 시공이 됐어도 장부상 우리 몫이 비어'
                    ' 있다(영준님 "우희근 반장의 실수니까 당연히 가야 하는 것이야").'
                    ' 정정 요청 목록 research/awms계기번호오입력_정정요청_20260923.json',
         공용함수명='mac_box_26_hits'),
    # ---- 25년불가 ----
